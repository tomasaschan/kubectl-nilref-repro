...
//+kubebuilder:resource:path=repros
...
var _ addonv1alpha1.CommonObject = &Repro{}

func (o *Repro) ComponentName() string {
	return "repro"
}

func (o *Repro) CommonSpec() addonv1alpha1.CommonSpec {
	return o.Spec.CommonSpec
}

func (o *Repro) PatchSpec() addonv1alpha1.PatchSpec {
	return o.Spec.PatchSpec
}

func (o *Repro) GetCommonStatus() addonv1alpha1.CommonStatus {
	return o.Status.CommonStatus
}

func (o *Repro) SetCommonStatus(s addonv1alpha1.CommonStatus) {
